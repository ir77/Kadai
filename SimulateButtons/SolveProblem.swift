...
class SolveProblem {
    ...
    func moveExperiment (tryTarget: cell, changeTarget: cell) -> Bool {
        ...
        // ?と爆弾は検証対象から除外
        guard .EMPTY == tryTarget.status && tryTarget.ichi != changeTarget.ichi else {
            return false
        }
